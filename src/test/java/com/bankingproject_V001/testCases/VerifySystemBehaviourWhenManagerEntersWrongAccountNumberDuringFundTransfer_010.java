...
public class VerifySystemBehaviourWhenManagerEntersWrongAccountNumberDuringFundTransfer_010 extends BaseClass {
	
	public LoginPage lpObj;
	
	@Test
	public void verifyingPopUpMsgAfterEnteringwrongAccountNumberDuringFundTransfer() throws InterruptedException
	{
		...
		Thread.sleep(3000);
		lpObj.setPayersAccountNumber("8018");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		boolean popUpMsgStatus=lpObj.verifyingPopupMsgFromAlert("Account 8018does not exist!!!");
		Thread.sleep(3000);
